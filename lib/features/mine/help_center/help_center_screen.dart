...
class HelpCenterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('帮助中心'), backgroundColor: AppTheme.surface),
      body: ListView(
        children: [
          ...
          _HelpSection(
            title: '常见问题',
            items: [
              _HelpItem(title: '如何开始训练?', content: '在首页选择一个品种，点击开始训练按钮即可开始模拟交易训练。'),
              _HelpItem(title: '训练数据如何获取?', content: '训练数据来自真实历史行情，系统会随机选择训练周期内的历史数据。'),
              _HelpItem(title: '如何添加自选品种?', content: '在品种列表中长按品种卡片，或在品种详情页点击添加自选按钮。'),
              _HelpItem(title: '训练报告如何生成?', content: '完成训练后系统会自动生成训练报告，包含收益率、胜率等统计数据。'),
            ],
          ),
          _HelpSection(
            title: '联系我们',
